...
"""
social-auth-backend-bigcommerce documentation build configuration file.
...
VERSION = get_version('../social-auth-backend-bigcommerce', '__init__.py')
...
project = 'social-auth-backend-bigcommerce'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'social-auth-backend-bigcommerce'
...
#
# html_title = 'social-auth-backend-bigcommerce v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'BigCommerce backend for Social Auth',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'social_auth_backend_bigcommerce'),
                os.path.join(root_path, 'social_auth_backend_bigcommerce/migrations')])
