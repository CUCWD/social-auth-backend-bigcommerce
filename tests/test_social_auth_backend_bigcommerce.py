...
class OktaOAuth2Test(OAuth2Test):
    ...
    """
    backend_path = 'social_auth_backend_bigcommerce.backend.DoceboOAuth2'
    user_data_url = 'https://testing.bigcommercesaas.com/manage/v1/user/session'
    ...
    def test_login(self):
        self.strategy.set_settings({
            'DOMAIN': 'testing.bigcommercesaas.com'
        })
        self.do_login()
